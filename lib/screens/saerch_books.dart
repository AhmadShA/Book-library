...
class SearchOfBooks extends StatefulWidget {
  final String IDCust;
  const SearchOfBooks({super.key, required this.IDCust});

  @override
  State<SearchOfBooks> createState() => _SearchOfBooksState();
}

class _SearchOfBooksState extends State<SearchOfBooks> {
                ...
                return Padding(
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        title: Text(
                          "Title Book: ${_filteredItems[i]["Title"]}",
                          style: const TextStyle(
                              fontSize: 22,
                        ...
                        subtitle:
                            Text("Type of Book: ${_filteredItems[i]["Type"]}"),
                        ...
                        trailing: IconButton.filled(
                          ...
                          onPressed: () {
                            setState(() {
                              ...
                              ID_book = _filteredItems[i]["ID_book"].toString();
                            });
                          },
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        "Price of book is: ${_filteredItems[i]["Price"]}\$",
                                        style: const TextStyle(fontSize: 18),
                                      ),
                                      const SizedBox(height: 8.0),
                                      Text(
                                        "The Author is: ${_filteredItems[i]["Fname"]} ${_filteredItems[i]["Lname"]}",
                                        style: const TextStyle(fontSize: 18),
                                      )
                                    ],
                                  ),
