...
class DisplayAuthorPage extends StatefulWidget {
  const DisplayAuthorPage({super.key});

  @override
  State<DisplayAuthorPage> createState() => _DisplayAuthorPageState();
}

class _DisplayAuthorPageState extends State<DisplayAuthorPage> {
              ...
              return Padding(
                ...
                child: Column(
                  children: [
                    ListTile(
                      title: Text(
                        "Author Name: ${authorList[i]["Fname"]} ${authorList[i]["Lname"]}",
                      ...
                      subtitle:
                          Text("Author gender: ${authorList[i]["gender"]}"),
                      leading: CircleAvatar(
                        radius: 20,
                        child: Text(
                            "${authorList[i]["Fname"].toString().substring(0, 2)}"),
                      ),
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "Author country: ${authorList[i]["country"]}",
                                  style: const TextStyle(fontSize: 18),
                                ),
                                const SizedBox(height: 8.0),
                                Text(
                                  "Author's books: ${authorList[i]["Title"]}",
                                  style: const TextStyle(fontSize: 18),
                                )
                              ],
                            ),
